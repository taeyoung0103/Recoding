...
<script>
    ...
    const emailCheck = () => {
        ...
        //위 소스에서의 입력값을 가져오는 내용
        const checkResult = document.getElementById("check-result");
        console.log("입력한 이메일", email);
        //ajax의 목적은 화면의 바뀌는거 없이 서버쪽과 통신을 주고받기 위함
        //post방식으로 밑에 주소로 보낼거고, 보내고자 하는 애용은 date:에 있는 것
        //"memberEmail": email에서 email은 위에 const email로 정의한것이다.
        $.ajax({
