...
public class MemberController {
    ...
    public String updateForm(HttpSession session, Model model) {
        ...
        MemberDTO memberDTO = memberService.findByMemberEmail(id);
    ...
    // gomap 매서드에서 id파라미터가 필요한데, 현재 코드에서 파라미터 없이 호출중이라 세션에서 id 가져옴
    @GetMapping("/gomap")
    public String goMapPage(HttpSession session, Model model) {
        String id = (String) session.getAttribute("id");
